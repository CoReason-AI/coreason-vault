...
def test_auth_approle(mock_hvac_client):
    ...
    client_instance.auth.approle.login.assert_called_with(
        role_id="role-id",
        secret_id="secret-id"
    )
...
def test_auth_kubernetes(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
    ...
    assert client == client_instance
    client_instance.auth.kubernetes.login.assert_called_with(
        role="k8s-role",
        jwt="k8s-token"
    )

def test_auth_missing_creds(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
...
def test_auth_failure_vault_error(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
...
def test_auth_failure_silent(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
...
def test_auth_unexpected_error(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
...
def test_reauthentication(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
...
def test_auth_kubernetes_missing_role(mock_hvac_client):
    mock_class, client_instance = mock_hvac_client
